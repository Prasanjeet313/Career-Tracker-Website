    ...
    <div className="main">
      ...
      <div className="box-container">
        <div className="box box1">
          <div className="text">
            ...
            <h2 className="topic">Profile Views</h2>
          </div>
          <img
        ...
        <div className="box box2">
          <div className="text">
            ...
            <h2 className="topic">Success Rate</h2>
          </div>
          <img
        ...
        <div className="box box3">
          <div className="text">
            ...
            <h2 className="topic">Interview Rate</h2>
          </div>
          <img
        ...
        <div className="box box4">
          <div className="text">
            ...
            <h2 className="topic">Skills Matched</h2>
          </div>
          <img
      ...
      <div className="report-container">
        <div className="report-header">
          <h1 className="recent-Articles">Recent Activity</h1>
          <button className="view">View All</button>
        </div>

        <div className="report-body">
          <div className="report-topic-heading">
            <h3 className="t-op">Activity</h3>
          ...
          <div className="items">
            <div className="item1">
              <h3 className="t-op-nextlvl">Post #38 </h3>
            ...
            <div className="item1">
              <h3 className="t-op-nextlvl">Post #37  </h3>
            ...
            <div className="item1">
              <h3 className="t-op-nextlvl">Post #36  </h3>
            ...
            <div className="item1">
              <h3 className="t-op-nextlvl">Post #35  </h3>
            ...
            <div className="item1">
              <h3 className="t-op-nextlvl">Post #34  </h3>
            ...
            <div className="item1">
              <h3 className="t-op-nextlvl">Post #33  </h3>
            ...
            <div className="item1">
              <h3 className="t-op-nextlvl">Post #32  </h3>
              <h3 className="t-op-nextlvl">1.2k</h3>
            ...
            <div className="item1">
              <h3 className="t-op-nextlvl">Post #31  </h3>
